# GR5398 26 Spring: FinRobot AI Agent Track
...
+ You should generate no less than 5 financial reports using different stocks in different industry field (better if they have different stock trends)
